...
@section('content')
     ...
     <a href="/dashboard/posts/create" class="btn btn-info btn-sm my-2"> Create New Post </a>
          ...
          <table class="table table-striped table-sm">
            ...
            <tbody>
               ...
               <tr>
                    ...
                    <td>
                         <a href="/dashboard/posts/{{ $post->id }}" class="badge bg-secondary"><span data-feather="eye"></span> </a>
